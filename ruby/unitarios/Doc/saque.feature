Estória: Saque no Caixa Eletrônico
    ...
    Para que eu consiga comprar em lugares que não aceitam dégito ou crédito. (mesmo estando no século 21 hahaha)
...
Cenário: Deu ruim não tenho saldo
    ...
    Então vejo a mensagem "Saldo infuficiente para saque :("
